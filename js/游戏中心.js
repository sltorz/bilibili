...
$(function(){
$(".lunbobottom li").mouseenter(function (e){

        var index=$(this).index();
        if(index==2) {
            index=index+1;
        var str="url('../image/mainmenu-li.png') no-repeat "+ (-200*index)+"px "+(-110)+"px"
        $($("li div")[index-1]).css("background",str);
}
   else {
            var str = "url('../image/mainmenu-li.png') no-repeat " + (-200 * index) + "px " + (-110) + "px"
            $($("li div")[index]).css("background", str);
        }
  $(this).css("background-image"," url('../image/slunbobottom1.jpg')")
    })
    $(".lunbobottom li").mouseleave(function (e){

        var index=$(this).index();
        if(index==2) {
            index=index+1;
            var str="url('../image/mainmenu-li.png') no-repeat "+ (-200*index)+"px 0px"
            $($("li div")[index-1]).css("background",str);
        }
        else {
            var str = "url('../image/mainmenu-li.png') no-repeat " + (-200 * index) + "px 0px"
...
var a=window.setInterval(function () {
    ...
    $(boxs[index]).fadeIn(700);
    index++;
},3500)
    $(".bottombox").mouseenter(function () {
        $(this).css("color" ,"white");
        $(this).css("background-color" ,"#00c3ff");
    })
